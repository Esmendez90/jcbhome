      ...
      <div className="journey-main-container">
        ...
        <section className="whykw-text-container journey-text-container" >
          ...
          <p>
            ...
            studied about real estate investments and eagerly assisted my family
            in the sale and purchase of properties. Back home, my parents were
            both independent contractors and their example motivated me to want
            to do the same... to be my own boss. When my job was affected by
            covid-19, I realized that my opportunity to go after my dream had
            finally arrived, and in March 2020 I began building my path in this
            rewarding career.
          </p>
          <p>
